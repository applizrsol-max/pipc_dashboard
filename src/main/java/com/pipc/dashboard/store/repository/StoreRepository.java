...
public interface StoreRepository extends JpaRepository<StoreEntity, Long> {
	...
	Optional<StoreEntity> findByDepartmentNameAndRowIdAndYear(String deptName, Integer rowId,String year);

	Optional<StoreEntity> findByDepartmentNameAndDeleteIdAndYear(String deptName, Long deleteId, String year);
